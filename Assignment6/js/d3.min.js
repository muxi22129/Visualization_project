...
!function (t, n) {
    ...
    function e(t) {
        ...
        return 1 === t.length && (e = (n, e) => t(n) - e, r = function (t) {
            ...
            left: i, center: function (t, n, r, o) {
    ...
    class g {
        ...
        add(t) {
            ...
            for (let r = 0; r < this._n && r < 32; r++) {
                const i = n[r], o = t + i, a = Math.abs(t) < Math.abs(i) ? t - (o - i) : i - (o - t);
                a && (n[e++] = a), t = o
            }
    ...
    class y extends Map {
        constructor(t = [], n = x) {
            super(), Object.defineProperties(this, {_intern: {value: new Map}, _key: {value: n}});
    ...
    function k(t, ...e) {
        ...
        if (1 === r.length || e.length > 1) {
            ...
            return e.length > 1 ? (e = e.map((n => t.map(n))), i.sort(((t, r) => {
                for (const i of e) {
                    const e = n(i[t], i[r]);
                    if (e) return e
                }
            }))) : (r = t.map(r), i.sort(((t, e) => n(r[t], r[e])))), E(t, i)
        }
        return t.sort(r)
    }
    ...
    function q(t, n, e) {
        ...
        if (a > 0) for (t = Math.ceil(t / a), n = Math.floor(n / a), o = new Array(i = Math.ceil(n - t + 1)); ++u < i;) o[u] = (t + u) * a; else for (a = -a, t = Math.ceil(t * a), n = Math.floor(n * a), o = new Array(i = Math.ceil(n - t + 1)); ++u < i;) o[u] = (t + u) / a;
    ...
    function I() {
        ...
        function r(r) {
            ...
            if (!Array.isArray(h)) {
                const t = l, e = +h;
                if (n === p && ([s, l] = O(s, l, e)), (h = q(s, l, e))[h.length - 1] >= l) if (t >= l && n === p) {
                    const t = R(s, l, e);
    ...
    function L(t, e, r = 0, i = t.length - 1, o = n) {
        for (; i > r;) {
            if (i - r > 600) {
                const n = i - r + 1, a = e - r + 1, u = Math.log(n), c = .5 * Math.exp(2 * u / 3),
                    f = .5 * Math.sqrt(u * c * (n - c) / n) * (a - n / 2 < 0 ? -1 : 1);
                L(t, e, Math.max(r, Math.floor(e - a * c / n + f)), Math.min(i, Math.floor(e + (n - a) * c / n + f)), o)
            }
            const n = t[e];
            let a = r, u = i;
            ...
            0 === o(t[r], n) ? j(t, r, u) : (++u, j(t, u, i)), u <= e && (r = u + 1), e <= u && (i = u - 1)
        }
        return t
    }
    ...
    function H(t, n, e) {
        if (r = (t = Float64Array.from(function* (t, n) {
            ...
            if (n >= 1) return B(t);
            var r, i = (r - 1) * n, o = Math.floor(i), a = B(L(t, o).subarray(0, o + 1));
    ...
    function tt(t) {
        ...
        for (var n = -1, e = Y(t, nt), r = new Array(e); ++n < e;) for (var i, o = -1, a = r[n] = new Array(i); ++o < i;) a[o] = t[o][n];
        return r
    }
    ...
    function rt(t, n) {
        const e = t[Symbol.iterator](), r = new Set;
        for (const t of n) {
            if (r.has(t)) continue;
            let n, i;
    ...
    function ht(t, n) {
        var e = [], r = null, i = null, o = 6, a = 6, u = 3, c = 1 === t || 4 === t ? -1 : 1,
            f = 4 === t || 2 === t ? "x" : "y", s = 1 === t || 3 === t ? ut : ct;

        function l(l) {
            var h = null == r ? n.ticks ? n.ticks.apply(n, e) : n.domain() : r,
                d = null == i ? n.tickFormat ? n.tickFormat.apply(n, e) : ot : i, p = Math.max(o, 0) + u, g = n.range(),
                y = +g[0] + .5, v = +g[g.length - 1] + .5, _ = (n.bandwidth ? st : ft)(n.copy()),
                b = l.selection ? l.selection() : l, m = b.selectAll(".domain").data([null]),
                x = b.selectAll(".tick").data(h, n).order(), w = x.exit(),
                M = x.enter().append("g").attr("class", "tick"), A = x.select("line"), T = x.select("text");
            m = m.merge(m.enter().insert("path", ".tick").attr("class", "domain").attr("stroke", "currentColor")), x = x.merge(M), A = A.merge(M.append("line").attr("stroke", "currentColor").attr(f + "2", c * o)), T = T.merge(M.append("text").attr("fill", "currentColor").attr(f, c * p).attr("dy", 1 === t ? "0em" : 3 === t ? "0.71em" : "0.32em")), l !== b && (m = m.transition(l), x = x.transition(l), A = A.transition(l), T = T.transition(l), w = w.transition(l).attr("opacity", at).attr("transform", (function (t) {
                return isFinite(t = _(t)) ? s(t) : this.getAttribute("transform")
            })), M.attr("opacity", at).attr("transform", (function (t) {
                ...
                return s(_(t))
            })), A.attr(f + "2", c * o), T.attr(f, c * p).text(d), b.filter(lt).attr("fill", "none").attr("font-size", 10).attr("font-family", "sans-serif").attr("text-anchor", 2 === t ? "start" : 4 === t ? "end" : "middle"), b.each((function () {
                this.__axis = _
            }))
        }
        ...
        return l.scale = function (t) {
            ...
            return e = it.call(arguments), l
        }, l.tickArguments = function (t) {
            return arguments.length ? (e = null == t ? [] : it.call(t), l) : e.slice()
        }, l.tickValues = function (t) {
            return arguments.length ? (r = null == t ? null : it.call(t), l) : r && r.slice()
    ...
    gt.prototype = pt.prototype = {
        constructor: gt, on: function (t, n) {
            var e, r = this._, i = yt(t + "", r), o = -1, a = i.length;
            if (!(arguments.length < 2)) {
                if (null != n && "function" != typeof n) throw new Error("invalid callback: " + n);
                for (; ++o < a;) if (e = (t = i[o]).type) r[e] = _t(r[e], t.name, n); else if (null == n) for (e in r) r[e] = _t(r[e], t.name, null);
                return this
            }
    ...
    var bt = "http://www.w3.org/1999/xhtml", mt = {
    ...
    function It(t, n, e, r, i, o) {
        for (var a, u = 0, c = n.length, f = o.length; u < f; ++u) (a = n[u]) ? (a.__data__ = o[u], r[u] = a) : e[u] = new Ot(t, o[u]);
    ...
    function Bt(t, n, e, r, i, o, a) {
        ...
        for (u = 0; u < h; ++u) f = a.call(t, o[u], u, o) + "", (c = s.get(f)) ? (r[u] = c, c.__data__ = o[u], s.delete(f)) : e[u] = new Ot(t, o[u]);
    ...
    Ot.prototype = {
        constructor: Ot, appendChild: function (t) {
    ...
    Pn.prototype = zn.prototype = {
        constructor: Pn, select: function (t) {
            ...
            var e = n ? Bt : It, r = this._parents, i = this._groups;
            "function" != typeof t && (t = Ut(t));
            for (var o = i.length, a = new Array(o), u = new Array(o), c = new Array(o), f = 0; f < o; ++f) {
                var s = r[f], l = i[f], h = l.length, d = Et(t.call(s, s && s.__data__, f, r)), p = d.length,
                    g = u[f] = new Array(p), y = a[f] = new Array(p), v = c[f] = new Array(h);
                e(s, l, g, y, v, d, n);
            ...
            var e = rn(t + "");
            if (arguments.length < 2) {
                for (var r = on(this.node()), i = -1, o = e.length; ++i < o;) if (!r.contains(e[i])) return !1;
                return !0
            }
            ...
            var e = "function" == typeof t ? t : At(t), r = null == n ? mn : "function" == typeof n ? n : St(n);
            return this.select((function () {
    ...
    function Yn(t) {
        var n = t.document.documentElement, e = Dn(t).on("dragstart.drag", Bn, !0);
        "onselectstart" in n ? e.on("selectstart.drag", Bn, !0) : (n.__noselect = n.style.MozUserSelect, n.style.MozUserSelect = "none")
    }

    function Ln(t, n) {
        var e = t.document.documentElement, r = Dn(t).on("dragstart.drag", null);
    ...
    var Qn = .7, Jn = 1 / Qn, te = "\\s*([+-]?\\d+)\\s*", ne = "\\s*([+-]?\\d*\\.?\\d+(?:[eE][+-]?\\d+)?)\\s*",
        ee = "\\s*([+-]?\\d*\\.?\\d+(?:[eE][+-]?\\d+)?)%\\s*", re = /^#([0-9a-f]{3,8})$/,
        ie = new RegExp("^rgb\\(" + [te, te, te] + "\\)$"), oe = new RegExp("^rgb\\(" + [ee, ee, ee] + "\\)$"),
        ae = new RegExp("^rgba\\(" + [te, te, te, ne] + "\\)$"),
        ue = new RegExp("^rgba\\(" + [ee, ee, ee, ne] + "\\)$"), ce = new RegExp("^hsl\\(" + [ne, ee, ee] + "\\)$"),
        fe = new RegExp("^hsla\\(" + [ne, ee, ee, ne] + "\\)$"), se = {
            aliceblue: 15792383,
    ...
    Wn(Kn, de, {
        ...
        }, hex: be, formatHex: be, formatRgb: me, toString: me
    })), Wn(Te, Ae, Zn(Kn, {
        brighter: function (t) {
    ...
    const Ee = Math.PI / 180, ke = 180 / Math.PI, Ne = .96422, Ce = .82521, Pe = 4 / 29, ze = 6 / 29, De = 3 * ze * ze;

    function qe(t) {
        if (t instanceof Fe) return new Fe(t.l, t.a, t.b, t.opacity);
        if (t instanceof je) return He(t);
        t instanceof _e || (t = ye(t));
        var n, e, r = Be(t.r), i = Be(t.g), o = Be(t.b), a = Oe((.2225045 * r + .7168786 * i + .0606169 * o) / 1);
    ...
    var Xe = -.14861, Ge = 1.78277, Ve = -.29227, $e = -.90649, We = 1.97294, Ze = We * $e, Ke = We * Ge,
        Qe = Ge * Ve - $e * Xe;

    function Je(t) {
        if (t instanceof nr) return new nr(t.h, t.s, t.l, t.opacity);
        t instanceof _e || (t = ye(t));
        var n = t.r / 255, e = t.g / 255, r = t.b / 255, i = (Qe * r + Ze * n - Ke * e) / (Qe + Ze - Ke), o = r - i,
            a = (We * (e - i) - Ve * o) / $e, u = Math.sqrt(a * a + o * o) / (We * i * (1 - i)),
    ...
    Wn(nr, tr, Zn(Kn, {
        brighter: function (t) {
            ...
            var t = isNaN(this.h) ? 0 : (this.h + 120) * Ee, n = +this.l, e = isNaN(this.s) ? 0 : this.s * n * (1 - n),
    ...
    var sr = function t(n) {
        ...
        function r(t, n) {
            var r = e((t = ve(t)).r, (n = ve(n)).r), i = e(t.g, n.g), o = e(t.b, n.b), a = fr(t.opacity, n.opacity);
            return function (n) {
    ...
    function lr(t) {
        return function (n) {
            ...
            for (e = 0; e < i; ++e) r = ve(n[e]), o[e] = r.r || 0, a[e] = r.g || 0, u[e] = r.b || 0;
    ...
    function br(t, n) {
        var e, r = {}, i = {};
        for (e in null !== t && "object" == typeof t || (t = {}), null !== n && "object" == typeof n || (n = {}), n) e in t ? r[e] = Mr(t[e], n[e]) : i[e] = n[e];
        return function (t) {
    ...
    function wr(t, n) {
        var e, r, i, o = mr.lastIndex = xr.lastIndex = 0, a = -1, u = [], c = [];
        for (t += "", n += ""; (e = mr.exec(t)) && (r = xr.exec(n));) (i = r.index) > o && (i = n.slice(o, i), u[a] ? u[a] += i : u[++a] = i), (e = e[0]) === (r = r[0]) ? u[a] ? u[a] += r : u[++a] = r : (u[++a] = null, c.push({
            i: a,
            x: _r(e, r)
        })), o = xr.lastIndex;
    ...
    var Dr = function t(n, e, r) {
        function i(t, i) {
            var o, a, u = t[0], c = t[1], f = t[2], s = i[0], l = i[1], h = i[2], d = s - u, p = l - c,
                g = d * d + p * p;
            if (g < 1e-12) a = Math.log(h / f) / n, o = function (t) {
                return [u + t * d, c + t * p, f * Math.exp(n * t * a)]
            }; else {
                var y = Math.sqrt(g), v = (h * h - f * f + r * g) / (2 * f * e * y),
                    _ = (h * h - f * f - r * g) / (2 * h * e * y), b = Math.log(Math.sqrt(v * v + 1) - v),
                    m = Math.log(Math.sqrt(_ * _ + 1) - _);
                a = (m - b) / n, o = function (t) {
                    var r = t * a, i = zr(b), o = f / (e * y) * (i * function (t) {
    ...
    function qr(t) {
        return function (n, e) {
            var r = t((n = Ae(n)).h, (e = Ae(e)).h), i = fr(n.s, e.s), o = fr(n.l, e.l), a = fr(n.opacity, e.opacity);
            return function (t) {
    ...
    function Or(t) {
        return function (n, e) {
            var r = t((n = Le(n)).h, (e = Le(e)).h), i = fr(n.c, e.c), o = fr(n.l, e.l), a = fr(n.opacity, e.opacity);
            return function (t) {
    ...
    function Br(t) {
        return function n(e) {
            function r(n, r) {
                var i = t((n = tr(n)).h, (r = tr(r)).h), o = fr(n.s, r.s), a = fr(n.l, r.l),
    ...
    var Hr, Xr, Gr = 0, Vr = 0, $r = 0, Wr = 0, Zr = 0, Kr = 0,
        Qr = "object" == typeof performance && performance.now ? performance : Date,
        Jr = "object" == typeof window && window.requestAnimationFrame ? window.requestAnimationFrame.bind(window) : function (t) {
            setTimeout(t, 17)
        };
    ...
    function oi() {
        ...
        try {
            ...
            Gr = 0, function () {
                var t, n, e = Hr, r = 1 / 0;
                for (; e;) e._call ? (r > e._time && (r = e._time), t = e, e = e._next) : (n = e._next, e._next = null, e = t ? t._next = n : Hr = n);
                Xr = t, ui(r)
            }(), Zr = 0
        }
    }
    ...
    ei.prototype = ri.prototype = {
        constructor: ei, restart: function (t, n, e) {
    ...
    ji.prototype = Hi.prototype = {
        ...
        select: function (t) {
            ...
            "function" != typeof t && (t = St(t));
            for (var r = this._groups, i = r.length, o = new Array(i), a = 0; a < i; ++a) for (var u, c, f = r[a], s = f.length, l = o[a] = new Array(s), h = 0; h < s; ++h) (u = f[h]) && (c = t.call(u, u.__data__, h, f)) && ("__data__" in u && (c.__data__ = u.__data__), l[h] = c, li(l[h], n, e, h, l, pi(u, e)));
        ...
        selectAll: function (t) {
            ...
            for (var r = this._groups, i = r.length, o = [], a = [], u = 0; u < i; ++u) for (var c, f = r[u], s = f.length, l = 0; l < s; ++l) if (c = f[l]) {
                for (var h, d = t.call(c, c.__data__, l, f), p = pi(c, e), g = 0, y = d.length; g < y; ++g) (h = d[g]) && li(h, n, e, g, d, p);
                o.push(d), a.push(c)
            }
        ...
        transition: function () {
            for (var t = this._name, n = this._id, e = Xi(), r = this._groups, i = r.length, o = 0; o < i; ++o) for (var a, u = r[o], c = u.length, f = 0; f < c; ++f) if (a = u[f]) {
                var s = pi(a, n);
        ...
        attr: function (t, n) {
            var e = xt(t), r = "transform" === e ? Pr : bi;
        ...
        style: function (t, n, e) {
            ...
            return null == n ? this.styleTween(t, function (t, n) {
                var e, r, i;
                return function () {
                    var o = Jt(this, t), a = (this.style.removeProperty(t), Jt(this, t));
                    return o === a ? null : o === e && a === r ? i : i = n(e = o, r = a)
                }
            }(t, r)).on("end.style." + t, Oi(t)) : "function" == typeof n ? this.styleTween(t, function (t, n, e) {
                var r, i, o;
                return function () {
                    var a = Jt(this, t), u = e(this), c = u + "";
                ...
                return function () {
                    var c = di(this, t), f = c.on, s = null == c.value[a] ? o || (o = Oi(n)) : void 0;
        ...
        tween: function (t, n) {
            ...
            if (t += "", arguments.length < 2) {
                for (var r, i = pi(this.node(), e).tween, o = 0, a = i.length; o < a; ++o) if ((r = i[o]).name === t) return r.value;
                return null
            }
    ...
    var uo = 1.70158, co = function t(n) {
        function e(t) {
        ...
        return n = +n, e.overshoot = t, e
    }(uo), lo = 2 * Math.PI, ho = function t(n, e) {
    ...
    }(1, .3), yo = {time: null, delay: 0, duration: 250, ease: $i};
    ...
    zn.prototype.interrupt = function (t) {
        ...
        for (var r = this._groups, i = r.length, o = 0; o < i; ++o) for (var a, u = r[o], c = u.length, f = 0; f < c; ++f) (a = u[f]) && li(a, t, n, f, u, e || vo(a, n));
    ...
    var zo = {
            name: "x", handles: ["w", "e"].map(Bo), input: function (t, n) {
                return null == t ? null : [[+t[0], n[0][1]], [+t[1], n[1][1]]]
            }, output: function (t) {
                return t && [t[0][0], t[1][0]]
            }
        }, Do = {
            name: "y", handles: ["n", "s"].map(Bo), input: function (t, n) {
                return null == t ? null : [[n[0][0], +t[0]], [n[1][0], +t[1]]]
            }, output: function (t) {
                return t && [t[0][1], t[1][1]]
            }
        }, qo = {
            name: "xy", handles: ["n", "w", "e", "s", "nw", "ne", "sw", "se"].map(Bo), input: function (t) {
    ...
    function Go(t) {
        var n, e = Lo, r = Yo, i = jo, o = !0, a = pt("start", "brush", "end"), u = 6;
        ...
        function f() {
            var t = Dn(this), n = Ho(this).selection;
        ...
        function h(e) {
            if ((!n || e.touches) && r.apply(this, arguments)) {
                var i, a, u, c, l, h, d, p, g, y, v, _ = this, b = e.target.__data__.type,
                    m = "selection" === (o && e.metaKey ? b = "overlay" : b) ? Mo : o && e.altKey ? So : To,
                    x = t === Do ? null : Uo[b], w = t === zo ? null : Io[b], M = Ho(_), A = M.extent, T = M.selection,
                    S = A[0][0], E = A[0][1], k = A[1][0], N = A[1][1], C = 0, P = 0, z = x && w && o && e.shiftKey,
                ...
                if ("overlay" === b) {
                    T && (g = !0);
                    const n = [D[0], D[1] || D[0]];
                    M.selection = T = [[i = t === Do ? S : No(n[0][0], n[1][0]), u = t === zo ? E : No(n[0][1], n[1][1])], [l = t === Do ? k : ko(n[0][0], n[1][0]), d = t === zo ? N : ko(n[0][1], n[1][1])]], D.length > 1 && I()
                } else i = T[0][0], u = T[0][1], l = T[1][0], d = T[1][1];
                a = i, c = u, h = l, p = d;
                var q = Dn(_).attr("pointer-events", "none"), R = q.selectAll(".overlay").attr("cursor", Ro[b]);
                gi(_);
            ...
            function U(t) {
                for (const n of t.changedTouches || [t]) for (const t of D) t.identifier === n.identifier && (t.cur = Un(n, _));
                if (z && !y && !v && 1 === D.length) {
                    const t = D[0];
        ...
        return c.move = function (n, e) {
            n.tween ? n.on("start.brush", (function (t) {
                ...
                var n = this, r = n.__brush, i = s(n, arguments), o = r.selection,
                    a = t.input("function" == typeof e ? e.apply(this, arguments) : e, r.extent), u = Mr(o, a);
                ...
                var n = this, r = arguments, i = n.__brush,
                    o = t.input("function" == typeof e ? e.apply(n, r) : e, i.extent), a = s(n, r).beforestart();
    ...
    function ra(t, n) {
        ...
        function a(a) {
            var u, c = a.length, f = new Array(c), s = na(0, c), l = new Array(c * c), h = new Array(c), d = 0;
            ...
            u = (d = Jo(0, Qo - e * c) / d) ? e : Qo / c;
            {
                ...
                for (const e of s) {
                    const r = n;
                    if (t) {
                        const t = na(1 + ~c, c).filter((t => t < 0 ? a[~t * c + e] : a[e * c + t]));
    ...
    ca.prototype = fa.prototype = {
        constructor: ca, moveTo: function (t, n) {
            ...
            if (null === this._x1) this._ += "M" + (this._x1 = t) + "," + (this._y1 = n); else if (l > aa) if (Math.abs(s * u - c * f) > aa && i) {
                var h = e - o, d = r - a, p = u * u + c * c, g = h * h + d * d, y = Math.sqrt(p), v = Math.sqrt(l),
                    _ = i * Math.tan((ia - Math.acos((p + l - g) / (2 * y * v))) / 2), b = _ / v, m = _ / y;
    ...
    function ba(t) {
        var n = ha, e = da, r = pa, i = pa, o = ga, a = ya, u = va, c = null;

        function f() {
            var f, s = n.apply(this, arguments), l = e.apply(this, arguments), h = u.apply(this, arguments) / 2,
                d = sa.call(arguments), p = +r.apply(this, (d[0] = s, d)), g = o.apply(this, d) - Ko,
                y = a.apply(this, d) - Ko, v = +i.apply(this, (d[0] = l, d)), _ = o.apply(this, d) - Ko,
                b = a.apply(this, d) - Ko;
            if (c || (c = f = fa()), h > ta && (Vo(y - g) > 2 * h + ta ? y > g ? (g += h, y -= h) : (g -= h, y += h) : g = y = (g + y) / 2, Vo(b - _) > 2 * h + ta ? b > _ ? (_ += h, b -= h) : (_ -= h, b += h) : _ = b = (_ + b) / 2), c.moveTo(p * $o(g), p * Wo(g)), c.arc(0, 0, p, g, y), g !== _ || y !== b) if (t) {
                var m = +t.apply(this, arguments), x = v - m, w = (_ + b) / 2;
    ...
    function ka() {
        ...
        function o(e, i) {
            ...
            return function (e, r, i) {
                ...
                Ea[f << 0].forEach(p);
                for (; ++u < n - 1;) {
                    for (o = -1, f = e[u * t + t] >= r, s = e[u * t] >= r, Ea[f << 1 | s << 2].forEach(p); ++o < t - 1;) c = f, f = e[u * t + t + o + 1] >= r, l = s, s = e[u * t + o + 1] >= r, Ea[c | f << 1 | s << 2 | l << 3].forEach(p);
                    Ea[f | s << 3].forEach(p)
                }
                o = -1, s = e[u * t] >= r, Ea[s << 2].forEach(p);
                for (; ++o < t - 1;) l = s, s = e[u * t + o + 1] >= r, Ea[s << 2 | l << 3].forEach(p);
                ...
                for (var n, e = 0, r = o.length; e < r; ++e) if (-1 !== Ma((n = o[e])[0], t)) return void n.push(t)
    ...
    class Fa {
        ...
        update() {
            const {coords: t, _hullPrev: n, _hullNext: e, _hullTri: r, _hullHash: i} = this, o = t.length >> 1;
            let a = 1 / 0, u = 1 / 0, c = -1 / 0, f = -1 / 0;
            for (let n = 0; n < o; n++) {
                const e = t[2 * n], r = t[2 * n + 1];
                e < a && (a = e), r < u && (u = r), e > c && (c = e), r > f && (f = r), this._ids[n] = n
            }
            const s = (a + c) / 2, l = (u + f) / 2;
            let h, d, p, g = 1 / 0;
            for (let n = 0; n < o; n++) {
                const e = Oa(s, l, t[2 * n], t[2 * n + 1]);
                e < g && (h = n, g = e)
            }
            const y = t[2 * h], v = t[2 * h + 1];
            g = 1 / 0;
            for (let n = 0; n < o; n++) {
                if (n === h) continue;
            ...
            let _ = t[2 * d], b = t[2 * d + 1], m = 1 / 0;
            for (let n = 0; n < o; n++) {
                if (n === h || n === d) continue;
                const e = Ya(y, v, _, b, t[2 * n], t[2 * n + 1]);
                e < m && (p = n, m = e)
            }
            let x = t[2 * p], w = t[2 * p + 1];
            if (m === 1 / 0) {
            ...
            const M = function (t, n, e, r, i, o) {
                const a = e - t, u = r - n, c = i - t, f = o - n, s = a * a + u * u, l = c * c + f * f,
                    h = .5 / (a * f - u * c);
            ...
            for (let o, a, u = 0; u < this._ids.length; u++) {
                const c = this._ids[u], f = t[2 * c], s = t[2 * c + 1];
                ...
                l = n[l];
                let g, y = l;
                for (; g = e[y], !Ia(f, s, t[2 * y], t[2 * y + 1], t[2 * g], t[2 * g + 1]);) if (y = g, y === l) {
                    y = -1;
                    break
                }
                if (-1 === y) continue;
                ...
                let _ = e[y];
                for (; g = e[_], Ia(f, s, t[2 * _], t[2 * _ + 1], t[2 * g], t[2 * g + 1]);) v = this._addTriangle(_, c, g, r[c], -1, r[_]), r[c] = this._legalize(v + 2), e[_] = _, A--, _ = g;
                if (y === l) for (; g = n[y], Ia(f, s, t[2 * g], t[2 * g + 1], t[2 * y], t[2 * y + 1]);) v = this._addTriangle(g, c, y, -1, r[y], r[g]), this._legalize(v + 2), r[g] = v, e[y] = y, A--, y = g;
        ...
        _legalize(t) {
            ...
            for (; ;) {
                ...
                const c = a - a % 3, f = u + (t + 1) % 3, s = c + (a + 2) % 3, l = n[o], h = n[t], d = n[f], p = n[s];
                if (Ba(r[2 * l], r[2 * l + 1], r[2 * h], r[2 * h + 1], r[2 * d], r[2 * d + 1], r[2 * p], r[2 * p + 1])) {
                    n[t] = p, n[a] = l;
                    const r = e[s];
                    if (-1 === r) {
    ...
    function Ba(t, n, e, r, i, o, a, u) {
        const c = t - a, f = n - u, s = e - a, l = r - u, h = i - a, d = o - u, p = s * s + l * l, g = h * h + d * d;
        return c * (l * g - p * d) - f * (s * g - p * h) + (c * c + f * f) * (s * d - l * h) < 0
    }

    function Ya(t, n, e, r, i, o) {
        const a = e - t, u = r - n, c = i - t, f = o - n, s = a * a + u * u, l = c * c + f * f,
            h = .5 / (a * f - u * c), d = (f * s - u * l) * h, p = (a * l - c * s) * h;
        return d * d + p * p
    }
    ...
    function La(t, n, e, r) {
        if (r - e <= 20) for (let i = e + 1; i <= r; i++) {
            ...
            let i = e + 1, o = r;
            ja(t, e + r >> 1, i), n[t[e]] > n[t[r]] && ja(t, e, r), n[t[i]] > n[t[r]] && ja(t, i, r), n[t[e]] > n[t[i]] && ja(t, e, i);
            const a = t[i], u = n[a];
            for (; ;) {
                do {
                    i++
    ...
    class Wa {
        ...
        _init() {
            ...
            for (let n, r, o = 0, a = 0, u = e.length; o < u; o += 3, a += 2) {
                const u = 2 * e[o], c = 2 * e[o + 1], f = 2 * e[o + 2], s = t[u], l = t[u + 1], h = t[c], d = t[c + 1],
                    p = t[f], g = t[f + 1], y = h - s, v = d - l, _ = p - s, b = g - l, m = y * y + v * v,
                    x = _ * _ + b * b, w = 2 * (y * b - v * _);
                if (w) if (Math.abs(w) < 1e-8) n = (s + p) / 2, r = (l + g) / 2; else {
                    const t = 1 / w;
        ...
        render(t) {
            ...
            for (let n = 0, r = e.length; n < r; ++n) {
                const r = e[n];
                if (r < n) continue;
                const i = 2 * Math.floor(n / 3), a = 2 * Math.floor(r / 3), u = o[i], c = o[i + 1], f = o[a],
                    s = o[a + 1];
            ...
            for (let n = 0; n < i.length; ++n) {
                u = c, c = i[n];
                const e = 2 * Math.floor(r[c] / 3), f = o[e], s = o[e + 1], l = 4 * u,
        ...
        renderCell(t, n) {
            const e = null == n ? n = new Va : void 0, r = this._clip(t);
        ...
        * neighbors(t) {
        ...
        _cell(t) {
            const {circumcenters: n, delaunay: {inedges: e, halfedges: r, triangles: i}} = this, o = e[t];
            if (-1 === o) return null;
            const a = [];
            let u = o;
            do {
        ...
        _clipFinite(t, n) {
            const e = n.length;
            let r, i, o, a, u, c = null, f = n[e - 2], s = n[e - 1], l = this._regioncode(f, s);
            for (let h = 0; h < e; h += 2) if (r = f, i = s, f = n[h], s = n[h + 1], o = l, l = this._regioncode(f, s), 0 === o && 0 === l) a = u, u = 0, c ? c.push(f, s) : c = [f, s]; else {
                let n, e, h, d, p;
                if (0 === o) {
        ...
        _edge(t, n, e, r, i) {
            ...
            if (r.length > 4) for (let t = 0; t < r.length; t += 2) {
                const n = (t + 2) % r.length, e = (t + 4) % r.length;
    ...
    class nu {
        ...
        _init() {
            ...
            if (t.hull && t.hull.length > 2 && function (t) {
                ...
                for (let t = 0; t < n.length; t += 3) {
                    const r = 2 * n[t], i = 2 * n[t + 1], o = 2 * n[t + 2];
            ...
            const e = this.halfedges = this._delaunator.halfedges, r = this.hull = this._delaunator.hull,
        ...
        * neighbors(t) {
        ...
        _step(t, n, e) {
            ...
            let f = t, s = Ka(n - c[2 * t], 2) + Ka(e - c[2 * t + 1], 2);
            const l = r[t];
            let h = l;
            do {
                let r = u[h];
                ...
                if (h = a[h], -1 === h) {
                    if (h = i[(o[t] + 1) % i.length], h !== r && Ka(n - c[2 * h], 2) + Ka(e - c[2 * h + 1], 2) < s) return h;
                    break
                }
            } while (h !== l);
            return f
        ...
        render(t) {
            const n = null == t ? t = new Va : void 0, {points: e, halfedges: r, triangles: i} = this;
        ...
        renderPoints(t, n = 2) {
            const e = null == t ? t = new Va : void 0, {points: r} = this;
        ...
        renderHull(t) {
            const n = null == t ? t = new Va : void 0, {hull: e, points: r} = this, i = 2 * e[0], o = e.length;
            t.moveTo(r[i], r[i + 1]);
            for (let n = 1; n < o; ++n) {
                const i = 2 * e[n];
                t.lineTo(r[i], r[i + 1])
        ...
        renderTriangle(t, n) {
            const e = null == n ? n = new Va : void 0, {points: r, triangles: i} = this, o = 2 * i[t *= 3],
                a = 2 * i[t + 1], u = 2 * i[t + 2];
    ...
    var fu = cu(","), su = fu.parse, lu = fu.parseRows, hu = fu.format, du = fu.formatBody, pu = fu.formatRows,
        gu = fu.formatRow, yu = fu.formatValue, vu = cu("\t"), _u = vu.parse, bu = vu.parseRows, mu = vu.format,
        xu = vu.formatBody, wu = vu.formatRows, Mu = vu.formatRow, Au = vu.formatValue;
    ...
    Xu.copy = function () {
        var t, n, e = new ju(this._x, this._y, this._x0, this._y0, this._x1, this._y1), r = this._root;
        if (!r) return e;
        ...
        for (this.cover(c, f).cover(s, l), e = 0; e < o; ++e) Uu(this, a[e], u[e], t[e]);
        return this
        ...
        for (g && p.push(new Iu(g, s, l, h, d)), null == e ? e = 1 / 0 : (s = t - e, l = n - e, h = t + e, d = n + e, e *= e); c = p.pop();) if (!(!(g = c.node) || (i = c.x0) > h || (o = c.y0) > d || (a = c.x1) < s || (u = c.y1) < l)) if (g.length) {
            var y = (i + a) / 2, v = (o + u) / 2;
            ...
            var _ = t - +this._x.call(null, g.data), b = n - +this._y.call(null, g.data), m = _ * _ + b * b;
            if (m < e) {
                var x = Math.sqrt(e = m);
        ...
        for (c && u.push(new Iu(c, this._x0, this._y0, this._x1, this._y1)); n = u.pop();) if (!t(c = n.node, r = n.x0, i = n.y0, o = n.x1, a = n.y1) && c.length) {
            var f = (r + o) / 2, s = (i + a) / 2;
    ...
    var fc = {
        ...
        s: function (t, n) {
            var e = ec(t, n);
            if (!e) return t + "";
            var r = e[0], i = e[1], o = i - (ic = 3 * Math.max(-8, Math.min(8, Math.floor(i / 3)))) + 1, a = r.length;
    ...
    function pc(t) {
        var n, e,
            ...
            }(hc.call(t.numerals, String)), c = void 0 === t.percent ? "%" : t.percent + "",
            f = void 0 === t.minus ? "−" : t.minus + "", s = void 0 === t.nan ? "NaN" : t.nan + "";

        function l(t) {
            var n = (t = ac(t)).fill, e = t.align, l = t.sign, h = t.symbol, d = t.zero, p = t.width, g = t.comma,
                y = t.precision, v = t.trim, _ = t.type;
            "n" === _ ? (g = !0, _ = "g") : fc[_] || (void 0 === y && (y = 12), v = !0, _ = "g"), (d || "0" === n && "=" === e) && (d = !0, n = "0", e = "=");
            var b = "$" === h ? i : "#" === h && /[boxX]/.test(_) ? "0" + _.toLowerCase() : "",
                m = "$" === h ? o : /[%p]/.test(_) ? c : "", x = fc[_], w = /[defgprs%]/.test(_);
            ...
            function M(t) {
                ...
                if ("c" === _) M = x(t) + M, t = ""; else {
                    ...
                    }(t)), A && 0 == +t && "+" !== l && (A = !1), h = (A ? "(" === l ? l : f : "-" === l || "(" === l ? "" : l) + h, M = ("s" === _ ? dc[8 + ic / 3] : "") + M + (A && "(" === l ? ")" : ""), w) for (i = -1, o = t.length; ++i < o;) if (48 > (c = t.charCodeAt(i)) || c > 57) {
                        M = (46 === c ? a + t.slice(i + 1) : t.slice(i)) + M, t = t.slice(0, i);
                        break
                    }
                }
                g && !d && (t = r(t, 1 / 0));
                var T = h.length + t.length + M.length, S = T < p ? new Array(p - T + 1).join(n) : "";
        ...
        return {
            format: l, formatPrefix: function (t, n) {
                var e = l(((t = ac(t)).type = "f", t)), r = 3 * Math.max(-8, Math.min(8, Math.floor(rc(n) / 3))),
                    i = Math.pow(10, -r), o = dc[8 + r / 3];
                return function (t) {
                    return e(i * t) + o
                }
            }
    ...
    var bc = 1e-6, mc = 1e-12, xc = Math.PI, wc = xc / 2, Mc = xc / 4, Ac = 2 * xc, Tc = 180 / xc, Sc = xc / 180,
        Ec = Math.abs, kc = Math.atan, Nc = Math.atan2, Cc = Math.cos, Pc = Math.ceil, zc = Math.exp, Dc = Math.hypot,
        qc = Math.log, Rc = Math.pow, Fc = Math.sin, Oc = Math.sign || function (t) {
    ...
    var Zc, Kc, Qc, Jc, tf, nf, ef, rf, of, af, uf, cf, ff, sf, lf, hf, df = new g, pf = new g, gf = {
        point: jc, lineStart: jc, lineEnd: jc, polygonStart: function () {
    ...
    function bf(t, n) {
        var e = (t *= Sc) - Qc, r = e >= 0 ? 1 : -1, i = r * e, o = Cc(n = (n *= Sc) / 2 + Mc), a = Fc(n), u = tf * a,
            c = Jc * o + u * Cc(i), f = u * r * Fc(i);
    ...
    var Ef, kf, Nf, Cf, Pf, zf, Df, qf, Rf, Ff, Of, Uf, If, Bf, Yf, Lf, jf = {
        point: Hf, lineStart: Gf, lineEnd: Vf, polygonStart: function () {
    ...
    function Xf(t, n) {
        var e = xf([t * Sc, n * Sc]);
        if (ff) {
            var r = Mf(ff, e), i = Mf([r[1], -r[0], 0], r);
            Sf(i), i = mf(i);
            var o, a = t - af, u = a > 0 ? 1 : -1, c = i[0] * Tc * u, f = Ec(a) > 180;
    ...
    var ts = {
        sphere: jc, point: ns, lineStart: rs, lineEnd: as, polygonStart: function () {
    ...
    function os(t, n) {
        t *= Sc;
        var e = Cc(n *= Sc), r = e * Cc(t), i = e * Fc(t), o = Fc(n),
    ...
    function ss(t, n) {
        t *= Sc;
        var e = Cc(n *= Sc), r = e * Cc(t), i = e * Fc(t), o = Fc(n), a = Yf * o - Lf * i, u = Lf * r - Bf * o,
            c = Bf * i - Yf * r, f = Dc(a, u, c), s = Yc(f), l = f && -s / f;
    ...
    function vs(t, n) {
        var e = Cc(t), r = Fc(t), i = Cc(n), o = Fc(n);

        function a(t, n) {
            var a = Cc(n), u = Cc(t) * a, c = Fc(t) * a, f = Fc(n), s = f * e + u * r;
            return [Nc(c * i - s * o, u * e - f * r), Yc(s * i + c * o)]
        }

        return a.invert = function (t, n) {
            var a = Cc(n), u = Cc(t) * a, c = Fc(t) * a, f = Fc(n), s = f * i - c * o;
    ...
    function bs(t, n, e, r, i, o) {
        if (e) {
            var a = Cc(n), u = Fc(n), c = r * e;
            null == i ? (i = n + r * Ac, o = n - c / 2) : (i = ms(a, i), o = ms(a, o), (r > 0 ? i < o : i > o) && (i += r * Ac));
            for (var f, s = i; r > 0 ? s > o : s < o; s -= c) f = mf([a, -u * Cc(s), -u * Fc(s)]), t.point(f[0], f[1])
        }
    }
    ...
    function Es(t, n) {
        var e = Ss(n), r = n[1], i = Fc(r), o = [Fc(e), -Cc(e), 0], a = 0, u = 0, c = new g;
        1 === i ? r = wc + bc : -1 === i && (r = -wc - bc);
        for (var f = 0, s = t.length; f < s; ++f) if (h = (l = t[f]).length) for (var l, h, d = l[h - 1], p = Ss(d), y = d[1] / 2 + Mc, v = Fc(y), _ = Cc(y), b = 0; b < h; ++b, p = x, v = M, _ = A, d = m) {
            var m = l[b], x = Ss(m), w = m[1] / 2 + Mc, M = Fc(w), A = Cc(w), T = x - p, S = T >= 0 ? 1 : -1, E = S * T,
                k = E > xc, N = v * M;
    ...
    function ks(t, n, e, r) {
        return function (i) {
            var o, a, u, c = n(i), f = xs(), s = n(f), l = !1, h = {
                point: d, lineStart: g, lineEnd: y, polygonStart: function () {
    ...
    function zs(t) {
        var n = Cc(t), e = 6 * Sc, r = n > 0, i = Ec(n) > bc;
        ...
        function a(t, e, r) {
            var i = [1, 0, 0], o = Mf(xf(t), xf(e)), a = wf(o, o), u = o[0], c = a - u * u;
            if (!c) return !r && t;
            var f = n * a / c, s = -n * u / c, l = Mf(i, o), h = Tf(i, f);
            Af(h, Tf(o, s));
            var d = l, p = wf(h, d), g = wf(d, d), y = p * p - g * (wf(h, h) - 1);
            if (!(y < 0)) {
                var v = Uc(y), _ = Tf(d, (-p - v) / g);
                if (Af(_, h), _ = mf(_), !r) return _;
                var b, m = t[0], x = e[0], w = t[1], M = e[1];
                x < m && (b = m, m = x, x = b);
                var A = x - m, T = Ec(A - xc) < bc;
        ...
        return ks(o, (function (t) {
            ...
            return {
                lineStart: function () {
                    ...
                    var d, p = [l, h], g = o(l, h), y = r ? g ? 0 : u(l, h) : g ? u(l + (l < 0 ? xc : -xc), h) : 0;
    ...
    function Is(t, n, e, r) {
        ...
        return function (a) {
            var c, f, s, l, h, d, p, g, y, v, _, b = a, m = xs(), x = {
    ...
    var Bs = {
        sphere: jc, point: jc, lineStart: function () {
    ...
    function js(t, n) {
        t *= Sc;
        var e = Fc(n *= Sc), r = Cc(n), i = Ec(t - qs), o = Cc(i), a = r * Fc(i), u = Fs * e - Rs * r * o,
            c = Rs * e + Fs * r * o;
    ...
    var $s = {
        Feature: function (t, n) {
            ...
            for (var e = t.features, r = -1, i = e.length; ++r < i;) if (Zs(e[r].geometry, n)) return !0;
            return !1
        }
    }, Ws = {
        Sphere: function () {
            ...
            for (var e = t.coordinates, r = -1, i = e.length; ++r < i;) if (Ks(e[r], n)) return !0;
            return !1
        }, LineString: function (t, n) {
            return Qs(t.coordinates, n)
        }, MultiLineString: function (t, n) {
            for (var e = t.coordinates, r = -1, i = e.length; ++r < i;) if (Qs(e[r], n)) return !0;
            return !1
        }, Polygon: function (t, n) {
            return Js(t.coordinates, n)
        }, MultiPolygon: function (t, n) {
            for (var e = t.coordinates, r = -1, i = e.length; ++r < i;) if (Js(e[r], n)) return !0;
            return !1
        }, GeometryCollection: function (t, n) {
            for (var e = t.geometries, r = -1, i = e.length; ++r < i;) if (Zs(e[r], n)) return !0;
            return !1
        }
    };
    ...
    var ol, al, ul, cl, fl = t => t, sl = new g, ll = new g, hl = {
        point: jc, lineStart: jc, lineEnd: jc, polygonStart: function () {
    ...
    var vl = 1 / 0, _l = vl, bl = -vl, ml = bl, xl = {
        point: function (t, n) {
            t < vl && (vl = t);
            t > bl && (bl = t);
            n < _l && (_l = n);
    ...
    var wl, Ml, Al, Tl, Sl = 0, El = 0, kl = 0, Nl = 0, Cl = 0, Pl = 0, zl = 0, Dl = 0, ql = 0, Rl = {
        point: Fl, lineStart: Ol, lineEnd: Bl, polygonStart: function () {
    ...
    function Il(t, n) {
        var e = t - Al, r = n - Tl, i = Uc(e * e + r * r);
    ...
    var Gl, Vl, $l, Wl, Zl, Kl = new g, Ql = {
        point: jc, lineStart: function () {
            Ql.point = Jl
        }, lineEnd: function () {
    ...
    nh.prototype = {
        _radius: 4.5, _circle: eh(4.5), pointRadius: function (t) {
        ...
        constructor: ih, point: function (t, n) {
    ...
    function lh(t, n) {
        return +n ? function (t, n) {
            function e(r, i, o, a, u, c, f, s, l, h, d, p, g, y) {
                var v = f - r, _ = s - i, b = v * v + _ * _;
                if (b > 4 * n && g--) {
                    var m = a + h, x = u + d, w = c + p, M = Uc(m * m + x * x + w * w), A = Yc(w /= M),
                        T = Ec(Ec(w) - 1) < bc || Ec(o - l) < bc ? (o + l) / 2 : Nc(x, m), S = t(T, A), E = S[0],
                        k = S[1], N = E - r, C = k - i, P = _ * N - v * C;
            ...
            return function (n) {
                var r, i, o, a, u, c, f, s, l, h, d, p, g = {
                    point: y, lineStart: v, lineEnd: b, polygonStart: function () {
    ...
    function dh(t, n, e, r, i, o) {
        ...
        var a = Cc(o), u = Fc(o), c = a * t, f = u * t, s = a / t, l = u / t, h = (u * e - a * n) / t,
            d = (u * n + a * e) / t;
    ...
    function gh(t) {
        var n, e, r, i, o, a, u, c, f, s, l = 150, h = 480, d = 250, p = 0, g = 0, y = 0, v = 0, _ = 0, b = 0, m = 1,
            x = 1, w = null, M = Ps, A = null, T = fl, S = .5;
        ...
        function N() {
            var t = dh(l, 0, 0, m, x, b).apply(null, n(p, g)), r = dh(l, h - t[0], d - t[1], m, x, b);
    ...
    function xh(t) {
        return function (n, e) {
            var r = Uc(n * n + e * e), i = t(r), o = Fc(i), a = Cc(i);
    ...
    function Th(t) {
        var n, e, r, i = ph(t), o = i.center, a = i.scale, u = i.translate, c = i.clipExtent, f = null;

        function s() {
            var o = xc * a(), u = i(_s(i.rotate()).invert([0, 0]));
    ...
    function Eh(t, n) {
        var e = Cc(t), r = t === n ? Fc(t) : qc(e / Cc(n)) / qc(Sh(n) / Sh(t)), i = e * Rc(Sh(t), r) / r;
        if (!r) return Ah;
        ...
        return o.invert = function (t, n) {
            var e = i - n, o = Oc(r) * Uc(t * t + e * e), a = Nc(t, Ec(e)) * Oc(e);
    ...
    function Nh(t, n) {
        var e = Cc(t), r = t === n ? Fc(t) : (e - Cc(n)) / (n - t), i = e / r + t;
    ...
    var Ch = 1.340264, Ph = -.081106, zh = 893e-6, Dh = .003796, qh = Uc(3) / 2;

    function Rh(t, n) {
        var e = Yc(qh * Fc(n)), r = e * e, i = r * r * r;
    ...
    function Xh(t, n) {
        ...
        for (var e, r, i, o, a, u = new Zh(t), c = [u]; e = c.pop();) if ((i = n(e.data)) && (a = (i = Array.from(i)).length)) for (e.children = i, o = a - 1; o >= 0; --o) c.push(r = i[o] = new Zh(i[o])), r.parent = e, r.depth = e.depth + 1;
    ...
    function Kh(t) {
        for (var n, e, r = 0, i = (t = function (t) {
            ...
            return t
        }(Array.from(t))).length, o = []; r < i;) n = t[r], e && td(e, n) ? ++r : (e = ed(o = Qh(o, n)), r = 0);
        return e
    }
    ...
    function Qh(t, n) {
        ...
        for (e = 0; e < t.length - 1; ++e) for (r = e + 1; r < t.length; ++r) if (Jh(rd(t[e], t[r]), n) && Jh(rd(t[e], n), t[r]) && Jh(rd(t[r], n), t[e]) && nd(id(t[e], t[r], n), t)) return [t[e], t[r], n];
        throw new Error
    }
    ...
    function td(t, n) {
        var e = t.r - n.r + 1e-9 * Math.max(t.r, n.r, 1), r = n.x - t.x, i = n.y - t.y;
        return e > 0 && e * e > r * r + i * i
    }
    ...
    function id(t, n, e) {
        var r = t.x, i = t.y, o = t.r, a = n.x, u = n.y, c = n.r, f = e.x, s = e.y, l = e.r, h = r - a, d = r - f,
            p = i - u, g = i - s, y = c - o, v = l - o, _ = r * r + i * i - o * o, b = _ - a * a - u * u + c * c,
            m = _ - f * f - s * s + l * l, x = d * p - h * g, w = (p * m - g * b) / (2 * x) - r,
            M = (g * y - p * v) / x, A = (d * b - h * m) / (2 * x) - i, T = (h * v - d * y) / x, S = M * M + T * T - 1,
            E = 2 * (o + w * M + A * T), k = w * w + A * A - o * o,
    ...
    function fd(t) {
        ...
        t:for (u = 3; u < i; ++u) {
            ...
            for (r.previous = n, r.next = e, n.next = e.previous = e = r, o = ud(n); (r = r.next) !== e;) (a = ud(r)) < o && (n = r, o = a);
            e = n.next
        }
    ...
    var Ud = Math.random, Id = function t(n) {
        function e(t, e) {
        ...
        function r(t, r) {
            ...
            var i = (t < 1 ? t + 1 : t) - 1 / 3, o = 1 / (3 * Math.sqrt(i)),
        ...
        var e = $d.source(n), r = Zd.source(n);
        ...
        var e = Wd.source(n), r = Kd.source(n);
    ...
    function up() {
        var t, n, e = ap().unknown(void 0), r = e.domain, i = e.range, o = 0, a = 1, u = !1, c = 0, f = 0, s = .5;

        function l() {
            var e = r().length, l = a < o, h = l ? a : o, d = l ? o : a;
    ...
    function pp(t, n, e) {
        var r = Math.min(t.length, n.length) - 1, i = new Array(r), a = new Array(r), u = -1;
        for (t[r] < t[0] && (t = t.slice().reverse(), n = n.slice().reverse()); ++u < r;) i[u] = hp(t[u], t[u + 1]), a[u] = e(n[u], n[u + 1]);
        return function (n) {
            var e = o(t, n, 1, r) - 1;
            return a[e](i[e](n))
        }
    ...
    function yp() {
        var t, n, e, r, i, o, a = sp, u = sp, c = Mr, f = lp;
    ...
    function Ep(n) {
        var e, r, i = n(xp, wp), o = i.domain, a = 10;
        ...
        return i.base = function (t) {
            ...
            (n = c < u) && (h = u, u = c, c = h);
            var f, s, l, h = e(u), d = e(c), p = null == t ? 10 : +t, g = [];
            if (!(a % 1) && d - h < p) {
    ...
    var Lp = Yp.range, jp = 1e3, Hp = 6e4, Xp = 36e5, Gp = 864e5, Vp = 6048e5, $p = Bp((function (t) {
    ...
    var rg = eg(0), ig = eg(1), og = eg(2), ag = eg(3), ug = eg(4), cg = eg(5), fg = eg(6), sg = rg.range,
        lg = ig.range, hg = og.range, dg = ag.range, pg = ug.range, gg = cg.range, yg = fg.range,
        vg = Bp((function (t) {
    ...
    var mg = bg.range, xg = Bp((function (t) {
        t.setUTCSeconds(0, 0)
    }), (function (t, n) {
        t.setTime(+t + n * Hp)
    }), (function (t, n) {
    ...
    var kg = Eg(0), Ng = Eg(1), Cg = Eg(2), Pg = Eg(3), zg = Eg(4), Dg = Eg(5), qg = Eg(6), Rg = kg.range,
        Fg = Ng.range, Og = Cg.range, Ug = Pg.range, Ig = zg.range, Bg = Dg.range, Yg = qg.range,
        Lg = Bp((function (t) {
    ...
    function Wg(t) {
        var n = t.dateTime, e = t.date, r = t.time, i = t.periods, o = t.days, a = t.shortDays, u = t.months,
            c = t.shortMonths, f = ry(i), s = iy(i), l = ry(o), h = iy(o), d = ry(a), p = iy(a), g = ry(u), y = iy(u),
            v = ry(c), _ = iy(c), b = {
                a: function (t) {
                    return a[t.getDay()]
                }, A: function (t) {
                    ...
                    return u[t.getMonth()]
                }, c: null, d: Ty, e: Ty, f: Cy, g: Yy, G: jy, H: Sy, I: Ey, j: ky, L: Ny, m: Py, M: zy, p: function (t) {
                ...
                }, c: null, d: Xy, e: Xy, f: Zy, g: uv, G: fv, H: Gy, I: Vy, j: $y, L: Wy, m: Ky, M: Qy, p: function (t) {
                    return i[+(t.getUTCHours() >= 12)]
                }, q: function (t) {
                    return 1 + ~~(t.getUTCMonth() / 3)
                }, Q: hv, s: dv, S: Jy, u: tv, U: nv, V: rv, w: iv, W: ov, x: null, X: null, y: av, Y: cv, Z: sv, "%": lv
            }, x = {
                a: function (t, n, e) {
                    ...
                    return A(t, n, e, r)
                }, d: gy, e: gy, f: xy, g: ly, G: sy, H: vy, I: vy, j: yy, L: my, m: py, M: _y, p: function (t, n, e) {
                    var r = f.exec(n.slice(e));
                    return r ? (t.p = s.get(r[0].toLowerCase()), e + r[0].length) : -1
                }, q: dy, Q: My, s: Ay, S: by, u: ay, U: uy, V: cy, w: oy, W: fy, x: function (t, n, r) {
                    return A(t, e, n, r)
                }, X: function (t, n, e) {
                    return A(t, r, n, e)
                }, y: ly, Y: sy, Z: hy, "%": wy
        ...
        function w(t, n) {
            return function (e) {
                ...
                for (e instanceof Date || (e = new Date(+e)); ++u < f;) 37 === t.charCodeAt(u) && (a.push(t.slice(c, u)), null != (i = Kg[r = t.charAt(++u)]) ? r = t.charAt(++u) : i = "e" === r ? " " : "0", (o = n[r]) && (r = o(e, i)), a.push(r), c = u + 1);
    ...
    function Sv(t, n, r, i, o, a, u, c, f) {
        var s = vp(), l = s.invert, h = s.domain, d = f(".%L"), p = f(":%S"), g = f("%I:%M"), y = f("%I %p"),
            v = f("%a %d"), _ = f("%b %d"), b = f("%B"), m = f("%Y"),
        ...
        function M(n, r, i) {
            if (null == n && (n = 10), "number" == typeof n) {
                var o, a = Math.abs(i - r) / n, u = e((function (t) {
                    return t[2]
                })).right(x, a);
        ...
        return s.invert = function (t) {
            ...
            var n, e = h(), r = e[0], i = e[e.length - 1], o = i < r;
    ...
    function Ev() {
        var t, n, e, r, i, o = 0, a = 1, u = lp, c = !1;
    ...
    function Cv() {
        var t, n, e, r, i, o, a, u = 0, c = .5, f = 1, s = 1, l = lp, h = !1;
        ...
        function p(t) {
            return function (n) {
                var e, r, i;
                return arguments.length ? ([e, r, i] = n, l = jr(t, [e, r, i]), d) : [l(0), l(.5), l(1)]
            }
        }
    ...
    var Dv = zv("1f77b4ff7f0e2ca02cd627289467bd8c564be377c27f7f7fbcbd2217becf"),
        ...
        Lv = zv("4e79a7f28e2ce1575976b7b259a14fedc949af7aa1ff9da79c755fbab0ab"), jv = t => hr(t[t.length - 1]),
        ...
        j_ = jv(L_);
    var H_ = Lr(tr(300, .5, 0), tr(-240, .5, 1)), X_ = Lr(tr(-100, .75, .35), tr(80, 1.5, .8)),
        G_ = Lr(tr(260, .75, .35), tr(80, 1.5, .8)), V_ = tr();
    ...
    var rb = Math.abs, ib = Math.atan2, ob = Math.cos, ab = Math.max, ub = Math.min, cb = Math.sin, fb = Math.sqrt,
        sb = 1e-12, lb = Math.PI, hb = lb / 2, db = 2 * lb;
    ...
    function wb(t, n, e, r, i, o, a) {
        var u = t - e, c = n - r, f = (a ? o : -o) / fb(u * u + c * c), s = f * c, l = -f * u, h = t + s, d = n + l,
            p = e + s, g = r + l, y = (h + p) / 2, v = (d + g) / 2, _ = p - h, b = g - d, m = _ * _ + b * b, x = i - o,
            w = h * g - p * d, M = (b < 0 ? -1 : 1) * fb(ab(0, x * x * m - w * w)), A = (w * b - _ * M) / m,
            T = (-w * _ - b * M) / m, S = (w * b + _ * M) / m, E = (-w * _ + b * M) / m, k = A - y, N = T - v,
            C = S - y, P = E - v;
    ...
    function Nb(t, n) {
        var e = eb(!0), r = null, i = Sb, o = null;

        function a(a) {
            var u, c, f, s = (a = Ab(a)).length, l = !1;
            for (null == r && (o = i(f = fa())), u = 0; u <= s; ++u) !(u < s && e(c = a[u], u, a)) === l && ((l = !l) ? o.lineStart() : o.lineEnd()), l && o.point(+t(c, u, a), +n(c, u, a));
    ...
    function Cb(t, n, e) {
        var r = null, i = eb(!0), o = null, a = Sb, u = null;

        function c(c) {
            var f, s, l, h, d, p = (c = Ab(c)).length, g = !1, y = new Array(p), v = new Array(p);
    ...
    function Ub() {
        var t = Cb().curve(Db), n = t.curve, e = t.lineX0, r = t.lineX1, i = t.lineY0, o = t.lineY1;
    ...
    function Lb(t) {
        var n = Bb, e = Yb, r = Eb, i = kb, o = null;

        function a() {
            var a, u = Mb.call(arguments), c = n.apply(this, u), f = e.apply(this, u);
    ...
    function Xb(t, n, e, r, i) {
        var o = Ib(n, e), a = Ib(n, e = (e + i) / 2), u = Ib(r, e), c = Ib(r, i);
    ...
    }, $b = Math.sqrt(1 / 3), Wb = 2 * $b, Zb = {
        draw: function (t, n) {
            var e = Math.sqrt(n / Wb), r = e * $b;
            t.moveTo(0, -e), t.lineTo(r, 0), t.lineTo(0, e), t.lineTo(-r, 0), t.closePath()
        }
    }, Kb = Math.sin(lb / 10) / Math.sin(7 * lb / 10), Qb = Math.sin(db / 10) * Kb, Jb = -Math.cos(db / 10) * Kb, tm = {
        draw: function (t, n) {
            var e = Math.sqrt(.8908130915292852 * n), r = Qb * e, i = Jb * e;
            t.moveTo(0, -e), t.lineTo(r, i);
            for (var o = 1; o < 5; ++o) {
                var a = db * o / 5, u = Math.cos(a), c = Math.sin(a);
    ...
    }, im = -.5, om = Math.sqrt(3) / 2, am = 1 / Math.sqrt(12), um = 3 * (am / 2 + 1), cm = {
        draw: function (t, n) {
            var e = Math.sqrt(n / um), r = e / 2, i = e * am, o = r, a = e * am + e, u = -o, c = a;
    ...
    hm.prototype = {
        ...
        areaStart: sm, areaEnd: sm, lineStart: function () {
    ...
    var ym = function t(n) {
        function e(t) {
            return 1 === n ? new hm(t) : new gm(t, n)
        }
    ...
    var Sm = function t(n) {
        function e(t) {
            return n ? new Tm(t, n) : new _m(t, 0)
        }
    ...
    function Dm(t, n, e) {
        ...
        return (zm(o) + zm(a)) * Math.min(Math.abs(o), Math.abs(a), .5 * Math.abs(u)) || 0
    }
    ...
    Pm.prototype = {
            ...
            if (n = +n, (t = +t) !== this._x1 || n !== this._y1) {
                switch (this._point) {
                    ...
                    case 1:
                        ...
                        break;
                    case 2:
                        this._point = 3, Rm(this, qm(this, e = Dm(this, t, n)), e);
                        break;
                    default:
                        Rm(this, this._t0, e = Dm(this, t, n))
                }
                this._x0 = this._x1, this._x1 = t, this._y0 = this._y1, this._y1 = n, this._t0 = e
            }
        }
    }, (Om.prototype = Object.create(Fm.prototype)).point = function (t, n) {
        Fm.prototype.point.call(this, n, t)
    }, Um.prototype = {
        moveTo: function (t, n) {
        ...
        areaStart: function () {
            ...
            if (e) if (this._line ? this._context.lineTo(t[0], n[0]) : this._context.moveTo(t[0], n[0]), 2 === e) this._context.lineTo(t[1], n[1]); else for (var r = Bm(t), i = Bm(n), o = 0, a = 1; a < e; ++o, ++a) this._context.bezierCurveTo(r[0][o], i[0][o], r[1][o], i[1][o], t[a], n[a]);
    ...
    function Km(t, {sourceEvent: n, target: e, transform: r, dispatch: i}) {
        Object.defineProperties(this, {
            type: {value: t, enumerable: !0, configurable: !0},
            sourceEvent: {value: n, enumerable: !0, configurable: !0},
            target: {value: e, enumerable: !0, configurable: !0},
    ...
    Qm.prototype = {
        constructor: Qm, scale: function (t) {
            return 1 === t ? this : new Qm(this.k * t, this.x, this.y)
        }, translate: function (t, n) {
            return 0 === t & 0 === n ? this : new Qm(this.k, this.x + this.k * t, this.y + this.k * n)
        }, apply: function (t) {
    ...
    function tx(t) {
        for (; !t.__zoom;) if (!(t = t.parentNode)) return Jm;
        return t.__zoom
    }
    ...
    tx.prototype = Qm.prototype, t.Adder = g, t.Delaunay = nu, t.FormatSpecifier = uc, t.InternMap = y, t.InternSet = v, t.Voronoi = Wa, t.active = function (t, n) {
        var e, r, i = t.__transition;
        if (i) for (r in n = null == n ? null : n + "", i) if ((e = i[r]).state > 1 && e.name === n) return new ji([[t]], _o, n, +r);
        return null
    }, t.arc = function () {
        var t = yb, n = vb, e = eb(0), r = null, i = _b, o = bb, a = mb, u = null;

        function c() {
            var c, f, s = +t.apply(this, arguments), l = +n.apply(this, arguments), h = i.apply(this, arguments) - hb,
                d = o.apply(this, arguments) - hb, p = rb(d - h), g = d > h;
            if (u || (u = c = fa()), l < s && (f = l, l = s, s = f), l > sb) if (p > db - sb) u.moveTo(l * ob(h), l * cb(h)), u.arc(0, 0, l, h, d, !g), s > sb && (u.moveTo(s * ob(d), s * cb(d)), u.arc(0, 0, s, d, h, g)); else {
                var y, v, _ = h, b = d, m = h, x = d, w = p, M = p, A = a.apply(this, arguments) / 2,
                    T = A > sb && (r ? +r.apply(this, arguments) : fb(s * s + l * l)),
                    S = ub(rb(l - s) / 2, +e.apply(this, arguments)), E = S, k = S;
                if (T > sb) {
                    var N = gb(T / s * cb(A)), C = gb(T / l * cb(A));
                    (w -= 2 * N) > sb ? (m += N *= g ? 1 : -1, x -= N) : (w = 0, m = x = (h + d) / 2), (M -= 2 * C) > sb ? (_ += C *= g ? 1 : -1, b -= C) : (M = 0, _ = b = (h + d) / 2)
                }
                var P = l * ob(_), z = l * cb(_), D = s * ob(x), q = s * cb(x);
                if (S > sb) {
                    var R, F = l * ob(b), O = l * cb(b), U = s * ob(m), I = s * cb(m);
                    if (p < lb && (R = xb(P, z, U, I, F, O, D, q))) {
                        var B = P - R[0], Y = z - R[1], L = F - R[0], j = O - R[1],
        ...
        var t = Pa, n = za, e = Da, r = 960, i = 500, o = 20, a = 2, u = 3 * o, c = r + 2 * u >> a, f = i + 2 * u >> a,
            s = wa(20);
        ...
        function l(r) {
            ...
            })), Na({width: c, height: f, data: i}, {width: c, height: f, data: l}, o >> a), Ca({
                width: c,
                height: f,
                data: l
            }, {width: c, height: f, data: i}, o >> a), Na({width: c, height: f, data: i}, {
                width: c,
                height: f,
                data: l
            }, o >> a), Ca({width: c, height: f, data: l}, {width: c, height: f, data: i}, o >> a), Na({
                width: c,
                height: f,
                data: i
            }, {width: c, height: f, data: l}, o >> a), Ca({width: c, height: f, data: l}, {
                width: c,
                height: f,
                data: i
            }, o >> a);
    ...
    }, t.creator = At, t.cross = function (...t) {
        const n = "function" == typeof t[t.length - 1] && function (t) {
            return n => t(...n)
        }(t.pop()), e = (t = t.map(l)).map(f), r = t.length - 1, i = new Array(r + 1).fill(0), o = [];
        ...
        return new pm(t)
    }, t.curveBundle = ym, t.curveCardinal = bm, t.curveCardinalClosed = xm, t.curveCardinalOpen = Mm, t.curveCatmullRom = Sm, t.curveCatmullRomClosed = km, t.curveCatmullRomOpen = Cm, t.curveLinear = Sb, t.curveLinearClosed = function (t) {
        return new Pm(t)
        ...
        const e = n[Symbol.iterator](), r = new Set;
        for (const n of t) {
            if (r.has(n)) return !1;
            let t, i;
        ...
        var t, n, e, r, i = Xn, o = Gn, a = Vn, u = $n, c = {}, f = pt("start", "drag", "end"), s = 0, l = 0;
        ...
        function p(r) {
            if (Bn(r), !e) {
                var i = r.clientX - t, o = r.clientY - n;
                e = i * i + o * o > l
            }
            c.mouse("drag", r)
        }
        ...
        function y(t, n) {
            if (i.call(this, t, n)) {
                ...
                for (e = 0; e < c; ++e) (r = b(this, u, t, n, a[e].identifier, a[e])) && (In(t), r("start", t, a[e]))
            }
        }
        ...
        function _(t) {
            ...
            for (r && clearTimeout(r), r = setTimeout((function () {
                r = null
            }), 500), n = 0; n < o; ++n) (e = c[i[n].identifier]) && (In(t), e("end", t, i[n]))
        }

        function b(t, n, e, r, i, o) {
            var u, l, d, p = f.copy(), g = Un(o || e, n);
        ...
        return 1 - no(t)
    },t.easeLinear = t => +t,t.easePoly = Ki,t.easePolyIn = Wi,t.easePolyInOut = Ki,t.easePolyOut = Zi,t.easeQuad = Vi,t.easeQuadIn = function (t) {
        return t * t
        ...
        function a() {
            for (var t, a, c, f, s, l, h, d = n.length, p = 0; p < o; ++p) for (a = Lu(n, $u, Wu).visitAfter(u), t = 0; t < d; ++t) c = n[t], l = e[c.index], h = l * l, f = c.x + c.vx, s = c.y + c.vy, a.visit(g);

            function g(t, n, e, o, a) {
                var u = t.data, d = t.r, p = l + d;
                if (!u) return n > f + p || o < f - p || e > s + p || a < s - p;
                if (u.index > c.index) {
                    var g = f - u.x - u.vx, y = s - u.y - u.vy, v = g * g + y * y;
        ...
        var n, e, r, i, o, a, u = Zu, c = function (t) {
            return 1 / Math.min(i[t.source.index], i[t.target.index])
        }, f = Gu(30), s = 1;

        function l(r) {
            for (var i = 0, u = t.length; i < s; ++i) for (var c, f, l, h, d, p, g, y = 0; y < u; ++y) f = (c = t[y]).source, h = (l = c.target).x + l.vx - f.x - f.vx || Vu(a), d = l.y + l.vy - f.y - f.vy || Vu(a), h *= p = ((p = Math.sqrt(h * h + d * d)) - e[y]) / p * r * n[y], d *= p, l.vx -= h * (g = o[y]), l.vy -= d * g, f.vx += h * (g = 1 - g), f.vy += d * g
        }

        function h() {
            if (r) {
                var a, c, f = r.length, s = t.length, l = new Map(r.map(((t, n) => [u(t, n, r), t])));
                for (a = 0, i = new Array(f); a < s; ++a) (c = t[a]).index = a, "object" != typeof c.source && (c.source = Ku(l, c.source)), "object" != typeof c.target && (c.target = Ku(l, c.target)), i[c.source.index] = (i[c.source.index] || 0) + 1, i[c.target.index] = (i[c.target.index] || 0) + 1;
        ...
        var t, n, e, r, i, o = Gu(-30), a = 1, u = 1 / 0, c = .81;

        function f(e) {
            var i, o = t.length, a = Lu(t, Ju, tc).visitAfter(l);
        ...
        var n, e = 1, r = .001, i = 1 - Math.pow(r, 1 / 300), o = 0, a = .6, u = new Map, c = ri(l),
            f = pt("tick", "end"), s = function () {
                let t = 1;
        ...
        var t, n, e, r, i, o, a = bh(), u = _h().rotate([154, 0]).center([-2, 58.5]).parallels([55, 65]),
            c = _h().rotate([157, 0]).center([-3, 19.9]).parallels([8, 18]), f = {
                point: function (t, n) {
                    o = [t, n]
                }
            };
        ...
        if (of = rf = -(nf = ef = 1 / 0), lf = [], Wc(t, jf), e = lf.length) {
            for (lf.sort(Qf), n = 1, o = [r = lf[0]]; n < e; ++n) Jf(r, (i = lf[n])[0]) || Jf(r, i[1]) ? (Kf(r[0], i[1]) > Kf(r[0], r[1]) && (r[1] = i[1]), Kf(i[0], r[1]) > Kf(r[0], r[1]) && (r[0] = i[0])) : o.push(r = i);
            for (a = -1 / 0, n = 0, r = o[e = o.length - 1]; n <= e; r = i, ++n) i = o[n], (u = Kf(r[1], i[0])) > a && (a = u, nf = i[0], rf = r[1])
        }
        ...
        function a() {
            var a = e.apply(this, arguments), u = r.apply(this, arguments) * Sc, c = i.apply(this, arguments) * Sc;
        ...
        var t, n, e, r, i, o, a, u = 1, c = 0, f = 0, s = 1, l = 1, h = 0, d = null, p = 1, g = 1, y = rh({
            point: function (t, n) {
                var e = b([t, n]);
        ...
        var e = t[0] * Sc, r = t[1] * Sc, i = n[0] * Sc, o = n[1] * Sc, a = Cc(r), u = Fc(r), c = Cc(o), f = Fc(o),
            s = a * Cc(e), l = a * Fc(e), h = c * Cc(i), d = c * Fc(i), p = 2 * Yc(Uc(Lc(o - r) + a * c * Lc(i - e))),
            g = Fc(p), y = p ? function (t) {
                var n = Fc(t *= p) / g, e = Fc(p - t) / g, r = e * s + n * h, i = e * l + n * d, o = e * u + n * f;
        ...
        var t = Th(Bh), n = t.center, e = t.rotate;
        ...
        return (1 === e.length ? k(A(t, e, r), (([t, e], [r, i]) => n(e, i) || n(t, r))) : k(M(t, r), (([t, r], [i, o]) => e(r, o) || n(t, i)))).map((([t]) => t))
        ...
        var e = fr((t = Re(t)).l, (n = Re(n)).l), r = fr(t.a, n.a), i = fr(t.b, n.b), o = fr(t.opacity, n.opacity);
        return function (n) {
    ...
    },t.interpolateViridis = Q_,t.interpolateWarm = X_,t.interpolateYlGn = E_,t.interpolateYlGnBu = T_,t.interpolateYlOrBr = N_,t.interpolateYlOrRd = P_,t.interpolateZoom = Dr,t.interrupt = gi,t.intersection = function (t, ...n) {
        ...
        var t = zb, n = Pb, e = null, r = eb(0), i = eb(db), o = eb(0);

        function a(a) {
            var u, c, f, s, l, h = (a = Ab(a)).length, d = 0, p = new Array(h), g = new Array(h),
                y = +r.apply(this, arguments), v = Math.min(db, Math.max(-db, i.apply(this, arguments) - y)),
                _ = Math.min(Math.abs(v) / h, o.apply(this, arguments)), b = _ * (v < 0 ? -1 : 1);
        ...
        return t.target && (t = On(t), void 0 === n && (n = t.currentTarget), t = t.touches || [t]), Array.from(t, (t => Un(t, n)))
        ...
        var o = Od(r), a = Od(i), u = a[0] === o[0], c = a[a.length - 1] === o[o.length - 1], f = [];
        ...
        return e
    },t.quickselect = L,t.radialArea = Ub,t.radialLine = Ob,t.randomBates = Hd,t.randomBernoulli = Vd,t.randomBeta = Zd,t.randomBinomial = Kd,t.randomCauchy = Jd,t.randomExponential = Xd,t.randomGamma = Wd,t.randomGeometric = $d,t.randomInt = Bd,t.randomIrwinHall = jd,t.randomLcg = function (t = Math.random()) {
        ...
        return ba(_a)
    },t.rollup = A,t.rollups = function (t, n, ...e) {
        ...
        var t = eb([]), n = jm, e = Lm, r = Hm;

        function i(i) {
            var o, a, u = Array.from(t.apply(this, arguments), Xm), c = u.length, f = -1;
            for (const t of i) for (o = 0, ++f; o < c; ++o) (u[o][f] = [0, +r(t, u[o].key, f, i)]).data = t;
            for (o = 0, a = Ab(n(u)); o < c; ++o) u[a[o]].index = o;
            return e(u, a), u
        }
        ...
        return i.keys = function (n) {
            ...
            return arguments.length ? (n = null == t ? jm : "function" == typeof t ? t : eb(Array.from(t)), i) : n
        }, i.offset = function (t) {
            return arguments.length ? (e = null == t ? Lm : t, i) : e
        }, i
    ...
    },t.stackOffsetNone = Lm,t.stackOffsetSilhouette = function (t, n) {
        if ((e = t.length) > 0) {
        ...
        if ((i = t.length) > 0 && (r = (e = t[n[0]]).length) > 0) {
            ...
            e[a - 1][1] += e[a - 1][0] = o, Lm(t, n)
        }
    },t.stackOrderAppearance = Gm,t.stackOrderAscending = $m,t.stackOrderDescending = function (t) {
        return $m(t).reverse()
    },t.stackOrderInsideOut = function (t) {
        var n, e, r = t.length, i = t.map(Wm), o = Gm(t), a = 0, u = 0, c = [], f = [];
        for (n = 0; n < r; ++n) e = o[n], a < u ? (a += i[e], c.push(e)) : (u += i[e], f.push(e));
        return f.reverse().concat(c)
    },t.stackOrderNone = jm,t.stackOrderReverse = function (t) {
        return jm(t).reverse()
    },t.stratify = function () {
        var t = wd, n = Md;

        function e(e) {
            var r, i, o, a, u, c, f, s = Array.from(e), l = s.length, h = new Map;
            for (i = 0; i < l; ++i) r = s[i], u = s[i] = new Zh(r), null != (c = t(r, i, e)) && (c += "") && (f = u.id = c, h.set(f, h.has(f) ? xd : u)), null != (c = n(r, i, e)) && (c += "") && (u.parent = c);
            for (i = 0; i < l; ++i) if (c = (u = s[i]).parent) {
        ...
        var t = Ad, n = 1, e = 1, r = null;

        function i(i) {
            var c = function (t) {
                for (var n, e, r, i, o, a = new Nd(t, 0), u = [a]; n = u.pop();) if (r = n._.children) for (n.children = new Array(o = r.length), i = o - 1; i >= 0; --i) u.push(e = n.children[i] = new Nd(r[i], i)), e.parent = n;
        ...
        function o(n) {
            ...
            n.parent.A = function (n, e, r) {
                if (e) {
                    for (var i, o = n, a = n, u = e, c = o.parent.children[0], f = o.m, s = a.m, l = u.m, h = c.m; u = Sd(u), o = Td(o), u && o;) c = Td(c), (a = Sd(a)).a = n, (i = u.z + l - o.z - f + t(u._, o._)) > 0 && (Ed(kd(u, n, r), n, i), f += i, s += i), l += u.m, f += o.m, h += c.m, s += a.m;
        ...
        var t = Dd, n = !1, e = 1, r = 1, i = [0], o = hd, a = hd, u = hd, c = hd, f = hd;
    ...
    },t.treemapSquarify = Dd,t.tsv = zu,t.tsvFormat = mu,t.tsvFormatBody = xu,t.tsvFormatRow = Mu,t.tsvFormatRows = wu,t.tsvFormatValue = Au,t.tsvParse = _u,t.tsvParseRows = bu,t.union = function (...t) {
        const n = new Set;
        ...
        var t, n, e, r = rx, i = ix, o = cx, a = ax, u = ux, c = [0, 1 / 0], f = [[-1 / 0, -1 / 0], [1 / 0, 1 / 0]],
            s = 250, l = Dr, h = pt("start", "zoom", "end"), d = 500, p = 0, g = 10;

        function y(t) {
            t.property("__zoom", ox).on("wheel.zoom", M).on("mousedown.zoom", A).on("dblclick.zoom", T).filter(u).on("touchstart.zoom", S).on("touchmove.zoom", E).on("touchend.zoom touchcancel.zoom", k).style("-webkit-tap-highlight-color", "rgba(0,0,0,0)")
        }

        function v(t, n) {
            return (n = Math.max(c[0], Math.min(c[1], n))) === t.k ? t : new Qm(n, t.x, t.y)
        }

        function _(t, n, e) {
            var r = n[0] - e[0] * t.k, i = n[1] - e[1] * t.k;
            return r === t.x && i === t.y ? t : new Qm(t.k, r, i)
        }
        ...
        function M(t, ...n) {
            if (r.apply(this, arguments)) {
                var e = x(this, n).event(t), i = this.__zoom,
                    u = Math.max(c[0], Math.min(c[1], i.k * Math.pow(2, a.apply(this, arguments)))), s = Un(t);
                ...
                ex(t), e.wheel = setTimeout(l, 150), e.zoom("mouse", o(_(v(i, u), e.mouse[0], e.mouse[1]), e.extent, f))
            }
        ...
        function A(t, ...n) {
            if (!e && r.apply(this, arguments)) {
                var i = x(this, n, !0).event(t), a = Dn(t.view).on("mousemove.zoom", h, !0).on("mouseup.zoom", d, !0),
                    u = Un(t, c), c = t.currentTarget, s = t.clientX, l = t.clientY;
                Yn(t.view), nx(t), i.mouse = [u, this.__zoom.invert(u)], gi(this), i.start()
            }

            function h(t) {
                if (ex(t), !i.moved) {
                    var n = t.clientX - s, e = t.clientY - l;
                    i.moved = n * n + e * e > p
                }
            ...
            function d(t) {
                a.on("mousemove.zoom mouseup.zoom", null), Ln(t.view, i.moved), ex(t), i.event(t).end()
            }
        }

        function T(t, ...n) {
            if (r.apply(this, arguments)) {
                var e = this.__zoom, a = Un(t.changedTouches ? t.changedTouches[0] : t, this), u = e.invert(a),
                    c = e.k * (t.shiftKey ? .5 : 2), l = o(_(v(e, c), a, u), i.apply(this, n), f);
                ex(t), s > 0 ? Dn(this).transition().duration(s).call(m, l, a, t) : Dn(this).call(y.transform, l, a, t)
            }
        }
        ...
        function S(e, ...i) {
            if (r.apply(this, arguments)) {
                ...
                for (nx(e), a = 0; a < s; ++a) c = [c = Un(u = f[a], this), this.__zoom.invert(c), u.identifier], l.touch0 ? l.touch1 || l.touch0[2] === c[2] || (l.touch1 = c, l.taps = 0) : (l.touch0 = c, o = !0, l.taps = 1 + !!t);
        ...
        function E(t, ...n) {
            if (this.__zooming) {
                ...
                for (ex(t), e = 0; e < s; ++e) i = Un(r = c[e], this), u.touch0 && u.touch0[2] === r.identifier ? u.touch0[0] = i : u.touch1 && u.touch1[2] === r.identifier && (u.touch1[0] = i);
        ...
        function k(t, ...r) {
            if (this.__zooming) {
                ...
                for (nx(t), e && clearTimeout(e), e = setTimeout((function () {
                    e = null
        ...
        return y.transform = function (t, n, e, r) {
            ...
            y.transform(t, (function () {
                ...
                return o(Jm.translate(u[0], u[1]).scale(a.k).translate("function" == typeof n ? -n.apply(this, arguments) : -n, "function" == typeof e ? -e.apply(this, arguments) : -e), t, f)
            }), r, a)
        }, w.prototype = {
            event: function (t) {
            ...
            return arguments.length ? (a = "function" == typeof t ? t : Zm(+t), y) : a
        }, y.filter = function (t) {
            return arguments.length ? (r = "function" == typeof t ? t : Zm(!!t), y) : r
        }, y.touchable = function (t) {
            return arguments.length ? (u = "function" == typeof t ? t : Zm(!!t), y) : u
        }, y.extent = function (t) {
            return arguments.length ? (i = "function" == typeof t ? t : Zm([[+t[0][0], +t[0][1]], [+t[1][0], +t[1][1]]]), y) : i
    ...
    },t.zoomIdentity = Jm,t.zoomTransform = tx,Object.defineProperty(t, "__esModule", {value: !0})
}));
